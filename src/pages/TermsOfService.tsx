...
const TermsOfService: FC = () => {
  ...
  return (
    <div className='kapwa-bg-surface-raised min-h-screen'>
      ...
      {/* Header Section */}
      <section className='from-primary-600 kapwa-text-inverse bg-linear-to-r to-blue-700 py-16'>
        <div className='container mx-auto px-4'>
          <div className='mx-auto max-w-4xl text-center'>
            <div className='mb-6 flex justify-center'>
              <div className='kapwa-bg-surface/20 rounded-full p-4 backdrop-blur-sm'>
                <Scale className='kapwa-text-inverse h-12 w-12' />
              </div>
            </div>
      ...
      <div className='container mx-auto max-w-4xl px-4 py-12'>
        <div className='kapwa-bg-surface space-y-8 rounded-lg p-8 shadow-lg'>
          {/* Acceptance of Terms */}
          <section>
          ...
          <section>
            ...
            <div className='kapwa-text-support space-y-4 leading-relaxed'>
              <p>
          ...
          <section>
            ...
            <div className='kapwa-text-support space-y-4 leading-relaxed'>
              ...
              <div className='kapwa-bg-info-weak mt-4 border-l-4 border-blue-400 p-4'>
                <p className='mb-2 font-semibold text-blue-800'>
                  We strongly encourage users to:
                </p>
                <ul className='kapwa-text-info list-inside list-disc space-y-1'>
                  <li>
          ...
          <section>
            ...
            <div className='kapwa-text-support space-y-4 leading-relaxed'>
              ...
              <div className='kapwa-border-weak kapwa-bg-surface-raised rounded-lg border p-4'>
                <h3 className='kapwa-text-strong mb-2 font-semibold'>
                ...
                <div className='mb-2 flex items-center gap-2'>
                  ...
                  <p className='font-semibold'>
                    ...
                    <a
                      ...
                      className='text-primary-600 hover:kapwa-text-brand'
                    >
              ...
              <div className='kapwa-bg-success-weak rounded-lg border border-green-200 p-4'>
              ...
              <div className='kapwa-bg-danger-weak rounded-lg border border-red-200 p-4'>
          ...
          <section className='border-t pt-8'>
            ...
            <div className='bg-primary-50 kapwa-border-brand rounded-lg border p-6'>
              ...
              <p className='text-primary-900 text-xl font-semibold'>
                <a
                  href='mailto:volunteers@bettergov.ph'
                  className='hover:kapwa-text-brand transition-colors'
                >
                  volunteers@bettergov.ph
                </a>
              </p>
            ...
            <div>
              <p className='kapwa-text-strong mt-4 font-semibold'>
