    ...
    <div className='animate-in fade-in mx-auto max-w-7xl space-y-6 px-4 pb-20 duration-500 md:px-0'>
      ...
      <div className='grid grid-cols-1 gap-12 lg:grid-cols-12'>
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          isChecked
                            ...
                            : 'hover:border-kapwa-border-weak border-slate-200 bg-transparent'
                        )}
                      >
                        {isChecked ? (
        ...
        <aside className='h-fit space-y-6 lg:sticky lg:top-32 lg:col-span-5'>
          ...
          <div className='ring-primary-500/10 text-kapwa-text-inverse min-h-[200px] rounded-3xl bg-slate-900 p-8 shadow-2xl ring-4'>
