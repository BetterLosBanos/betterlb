...
const JoinUsStrip: FC = () => {
  ...
  return (
    <div className='kapwa-text-inverse relative overflow-hidden bg-linear-to-r from-orange-500 via-red-500 to-pink-500 py-3'>
      <div className='kapwa-bg-surface-bold/10 absolute inset-0'></div>
      ...
      <div className='relative z-10 container mx-auto px-4'>
        <div className='flex flex-col items-center justify-between gap-2 sm:flex-row'>
          ...
          <div className='flex items-center gap-3'>
            <Link
              to='/join-us'
              className='kapwa-text-strong inline-flex transform items-center gap-2 rounded-full bg-yellow-300 px-4 py-1.5 text-sm font-semibold whitespace-nowrap transition-all hover:scale-105 hover:bg-yellow-200'
            >
              {t('joinUs.joinNow')}
