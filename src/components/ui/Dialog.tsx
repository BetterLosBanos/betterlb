...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={`text-sm text-kapwa-text-disabled ${className}`}
    {...props}
  />
));
