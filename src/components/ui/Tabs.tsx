...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-md bg-kapwa-bg-surface-raised p-1 text-kapwa-text-strong0',
      className
    )}
    {...props}
  />
